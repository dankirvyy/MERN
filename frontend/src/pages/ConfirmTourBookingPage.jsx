...
// --- Main Component ---
function ConfirmTourBookingPage() {
    ...
    if (!booking) {
        return (
            <div className="text-center p-12">
                ...
                <Link to="/tours" className="text-orange-600">Please start your booking again.</Link>
            </div>
        );
    }
    ...
    const finalizeBooking = async (paymentDetails) => {
        ...
        try {
            ...
            await axios.post('http://localhost:5001/api/bookings/tour', body, config);
    ...
    const handlePaymentSubmit = async (e) => {
        ...
        try {
            if (method === 'gcash') {
                ...
                localStorage.setItem('pending_tour_booking', JSON.stringify(bookingWithPaymentOption));
            ...
            <div className="bg-white py-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <h2 className="text-3xl font-extrabold text-gray-900">Review Your Tour Reservation</h2>
                        <p className="mt-4 text-lg text-gray-500">Please confirm the details below.</p>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <dl className="mt-4 space-y-4">
                                        <div className="flex justify-between"><dt className="text-sm font-medium text-gray-500">Tour</dt><dd className="text-sm font-medium text-gray-900">{booking.tourData.name}</dd></div>
                                        <div className="flex justify-between"><dt className="text-sm font-medium text-gray-500">Date</dt><dd className="text-sm font-medium text-gray-900">{formatDate(booking.bookingData.booking_date)}</dd></div>
                                        <div className="flex justify-between"><dt className="text-sm font-medium text-gray-500">Guests</dt><dd className="text-sm font-medium text-gray-900">{booking.bookingData.number_of_pax}</dd></div>
                                        <div className="flex justify-between"><dt className="text-sm font-medium text-gray-500">Duration</dt><dd className="text-sm font-medium text-gray-900">{booking.tourData.duration}</dd></div>
...
export default ConfirmTourBookingPage;